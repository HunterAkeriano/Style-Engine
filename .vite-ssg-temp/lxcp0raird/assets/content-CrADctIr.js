  ...
  en: {
    page: {
      hero: {
        ...
        subtitle: "Documentation page with copyable snippets and live previews so you can see how gradients, shadow stacks, and keyframes work. Quick links jump into focused subpages for each effect type.",
  ...
  uk: {
    page: {
      hero: {
        ...
        subtitle: "Сторінка з документацією, готовими прикладами та живими прев’ю, щоб ви бачили, як працюють градієнти, стекинг тіней та keyframes. Є швидкі переходи у підрозділи для кожного типу ефектів.",
...
function getDocsPageContent(locale) {
  var _a;
  return ((_a = docsContent[locale]) == null ? void 0 : _a.page) ?? docsContent.en.page;
}
function getDocsTopics(locale) {
  var _a;
  return ((_a = docsContent[locale]) == null ? void 0 : _a.topics) ?? docsContent.en.topics;
}
function getDocsTopicContent(locale, slug) {
...
export {
  getDocsTopicContent as a,
  getDocsPageContent as g
};
