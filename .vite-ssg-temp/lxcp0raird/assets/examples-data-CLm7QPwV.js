const animationExamples = [
  {
    ...
    category: "loaders",
    component: () => import("./AnimationTripleSpinner-BSQujn-r.js"),
...
@keyframes triple-spin { to { transform: rotate(360deg); } }`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationCubePulse-CFCgQPs-.js"),
...
@keyframes cube-pulse {0%,100%{transform:scale(.9);opacity:.85;}50%{transform:scale(1.15);opacity:1;}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationLineDance-LHOToL3f.js"),
...
@keyframes line-dance {0%,100%{transform:scaleY(.5);opacity:.7;}50%{transform:scaleY(1.2);opacity:1;}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationRingDash-Zq4C90FS.js"),
...
@keyframes ring-dash-reverse{to{transform:rotate(-360deg);}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationBeamLoader-1AAUfVJW.js"),
...
@keyframes beam-slide{0%{transform:translateX(-80%);}100%{transform:translateX(140%);}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationStackBounce-3Y042xBl.js"),
...
@keyframes stack-bounce{0%,100%{transform:translateY(0);opacity:.85;}50%{transform:translateY(-8px);opacity:1;}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationClockLoader-GpQsQ7nu.js"),
...
@keyframes clock-minute{to{transform:rotate(720deg);}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationPulseGrid-B4mFXl5o.js"),
...
@keyframes pulse-grid{0%,100%{transform:scale(.85);opacity:.8;}50%{transform:scale(1.08);opacity:1;}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationWaveOrb-CdjC2IpI.js"),
...
@keyframes wave-core{0%,100%{transform:scale(1);}50%{transform:scale(1.12);}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationDotTyping-CGbBKM5G.js"),
...
@keyframes dot-typing{0%,100%{transform:translateY(0);opacity:.7;}50%{transform:translateY(-8px);opacity:1;}}`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationBeatGrid-BRL6ndAQ.js"),
...
@keyframes beat-grid{0%,100%{transform:scale(.85);opacity:.8;}50%{transform:scale(1.15);opacity:1;}}`
  },
  {
    ...
    category: "marquee",
    component: () => import("./AnimationTicker-BbCSqjPp.js"),
...
@keyframes scroll {
  ...
  },
  {
    ...
    category: "orbital",
    component: () => import("./AnimationOrbits-OX329P3U.js"),
...
@keyframes spinRing { to { transform: rotate(360deg); } }`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationPulseLines-UbnKFWGG.js"),
...
@keyframes rise { 0% { transform: translateY(6px) scaleY(0.9); opacity: 0.8; } 50% { transform: translateY(-10px) scaleY(1.05); opacity: 1; } 100% { transform: translateY(6px) scaleY(0.9); opacity: 0.8; } }`
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationStarTrail-0zTrUUjo.js"),
...
@keyframes stretch { 0% { transform: translateX(0) scaleX(0.4); opacity: 0; } 15% { opacity: 0.9; } 50% { transform: translateX(240px) scaleX(1); opacity: 1; } 100% { transform: translateX(440px) scaleX(0.4); opacity: 0; } }`
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationBounceDots-PE76W9JO.js"),
...
@keyframes dotBounce {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationPulseRing-Dgh4gEa1.js"),
...
@keyframes pulseWave {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationLoaderBars-DNdTNvCL.js"),
...
@keyframes bars {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationRotateSquare-Dk9iJ9mZ.js"),
...
@keyframes rotateShape {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationFlipCard-Df404MFB.js"),
...
@keyframes flipCard {
  ...
  },
  {
    ...
    category: "orbital",
    component: () => import("./AnimationGlowOrbit-CsI7CxI7.js"),
...
@keyframes orbSpin {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationTyping-CkTcrAss.js"),
...
@keyframes blink {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationRadar-DqYVdZoe.js"),
...
@keyframes radarSpin {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationWaveLines-BiMscTtT.js"),
...
@keyframes waveSlide {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationColorShift-C-Bzzd-l.js"),
...
@keyframes hueSpin {
  ...
  },
  {
    ...
    component: () => import("./AnimationScaleFade-BK0tBSnI.js"),
...
@keyframes scaleFade {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationShimmerCard-3eHpWHvR.js"),
...
@keyframes shimmer {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationSlideBadge-D7nM7LzO.js"),
...
@keyframes slidePulse {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationRipple-DXUruRlk.js"),
...
@keyframes rippleWave {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationMeteor-Brr10Z2o.js"),
...
@keyframes meteorFly {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationMorphBlob-CZnwJXm6.js"),
...
@keyframes blobMorph {
  ...
  },
  {
    ...
    category: "transitions",
    component: () => import("./AnimationStaggerList-DiEdBVWk.js"),
...
@keyframes stagger {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationLiquid-CkcmhTV3.js"),
...
@keyframes waveMove {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationSpinnerLines-Yg05tFaA.js"),
...
@keyframes spinLine {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationGradientWipe-B0OiZBuN.js"),
...
@keyframes wipe {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationDotsChain-CW7bXr6o.js"),
...
@keyframes chainPulse {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationCircleLoader-k1xgV_85.js"),
...
@keyframes ringRotate {
  ...
  },
  {
    ...
    category: "loaders",
    component: () => import("./AnimationProgressBar-DmQJaOmY.js"),
...
@keyframes progressFill {
  ...
  },
  {
    ...
    category: "marquee",
    component: () => import("./AnimationVerticalMarquee-OAVi0kAZ.js"),
...
@keyframes verticalScroll {
  ...
  },
  {
    ...
    category: "effects",
    component: () => import("./AnimationTextReveal-DUXC38cJ.js"),
...
@keyframes textShine {
  ...
  },
  {
    ...
    category: "marquee",
    component: () => import("./AnimationNewsScroll-DdAxAtbu.js"),
