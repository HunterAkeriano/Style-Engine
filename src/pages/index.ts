...
export { default as PrivacyPolicyPage } from './policy/PrivacyPolicyPage.vue'
export { default as CookiePolicyPage } from './policy/CookiePolicyPage.vue'
export { default as ForgotPasswordPage } from './forgot-password/ForgotPasswordPage.vue'
export { default as ResetPasswordPage } from './reset-password/ResetPasswordPage.vue'
