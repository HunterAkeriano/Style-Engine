<template>
  <svg class="svg-sprite" aria-hidden="true" focusable="false">
    ...
    <symbol id="icon-logo" viewBox="0 0 48 48">
      ...
      <path
        d="M13 13c-3 0-4.5 1.5-4.5 4.5v4c0 1.5-1 2.5-2.5 2.5 1.5 0 2.5 1 2.5 2.5v4c0 3 1.5 4.5 4.5 4.5"
        stroke="white"
        stroke-width="2.5"
        stroke-linecap="round"
        fill="none"
      />
      <path
        d="M35 13c3 0 4.5 1.5 4.5 4.5v4c0 1.5 1 2.5 2.5 2.5-1.5 0-2.5 1-2.5 2.5v4c0 3-1.5 4.5-4.5 4.5"
        stroke="white"
        stroke-width="2.5"
        stroke-linecap="round"
        fill="none"
    ...
    <symbol id="icon-google" viewBox="0 0 18 18">
      <path
        d="M16.337 9.205c0-.64-.057-1.253-.164-1.84H9v3.48h4.117c-.177.956-.715 1.766-1.526 2.31v1.92h2.469c1.444-1.33 2.277-3.293 2.277-5.87Z"
        fill="#4285F4"
      />
      <path
        d="M9 17c2.07 0 3.804-.687 5.072-1.825l-2.469-1.92c-.685.46-1.56.735-2.603.735-2.005 0-3.705-1.356-4.313-3.176H1.13v1.996A8 8 0 0 0 9 17Z"
        fill="#34A853"
      />
      <path
        d="M4.687 10.814A4.812 4.812 0 0 1 4.435 9c0-.636.114-1.25.252-1.814V5.19H1.13A8 8 0 0 0 1 9c0 1.297.31 2.523.87 3.809l2.817-2Z"
        fill="#FBBC04"
      />
      <path
        d="M9 4.064c1.126 0 2.132.387 2.927 1.144l2.196-2.196C12.804 1.687 11.07 1 9 1a8 8 0 0 0-7.13 4l3.317 2.444C5.295 5.42 6.995 4.064 9 4.064Z"
        fill="#EA4335"
      />
    </symbol>
    ...
    <symbol id="icon-github" viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M12 .5C5.649.5.5 5.65.5 12.004c0 5.093 3.293 9.403 7.86 10.93.575.105.787-.246.787-.55 0-.272-.011-1.17-.016-2.122-3.197.695-3.873-1.374-3.873-1.374-.523-1.327-1.277-1.68-1.277-1.68-1.042-.713.079-.699.079-.699 1.152.081 1.757 1.183 1.757 1.183 1.025 1.756 2.689 1.249 3.345.955.104-.743.401-1.25.73-1.538-2.552-.29-5.236-1.277-5.236-5.683 0-1.255.448-2.281 1.183-3.085-.119-.29-.513-1.458.112-3.04 0 0 .965-.309 3.163 1.178a11.03 11.03 0 0 1 2.879-.387c.976.004 1.958.132 2.879.387 2.197-1.487 3.161-1.178 3.161-1.178.627 1.582.233 2.75.114 3.04.737.804 1.182 1.83 1.182 3.085 0 4.418-2.689 5.39-5.253 5.672.413.356.781 1.058.781 2.133 0 1.54-.014 2.778-.014 3.158 0 .306.208.662.793.549 4.562-1.53 7.852-5.838 7.852-10.93C23.5 5.65 18.35.5 12 .5Z"
      />
    </symbol>
  </svg>
</template>
