export default {
  ...
  PRIVACY: {
    ...
    SUBTITLE:
      'Ми збираємо лише мінімум, щоб працювали генератори, збереження і профіль. Нижче — як саме це працює.',
    PILL_CORE: 'Які дані',
    ...
    SECTIONS: {
      ...
      CONTACT_BODY:
        'Напишіть на privacy (at) styleengine.dev — відповімо деталями або виконаємо ваш запит.'
    }
  },
  COOKIE: {
    NAV: 'Політика Cookie',
    ...
    SUBTITLE:
      'Ми використовуємо мінімальні cookie, щоб пам’ятати налаштування, тримати вхід і бачити, що справді допомагає.',
    PILL_TYPES: 'Типи',
  ...
  COOKIE_MODAL: {
    ...
    DESCRIPTION:
      'Вони зберігають вхід, пам’ятають налаштування і показують, що справді допомагає. Ви керуєте, що робити далі.',
