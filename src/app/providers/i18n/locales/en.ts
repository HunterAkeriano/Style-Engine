export default {
  ...
  QUIZ: {
    HERO_TITLE: 'Test Your CSS Skills',
    HERO_SUBTITLE: 'Challenge yourself with interactive quizzes covering CSS, SCSS, and Stylus',
    WHY_TESTING_TITLE: 'Why Take CSS Quizzes?',
    WHY_TESTING_REASONS: {
      REASON1: 'Identify knowledge gaps and strengthen weak areas in your CSS understanding',
      REASON2: 'Practice real-world scenarios and learn best practices from detailed feedback',
      REASON3: 'Track your progress over time and compete with other developers globally',
      REASON4: 'Prepare for technical interviews and validate your front-end development skills'
    },
    ...
    SUPPORT_DESCRIPTION:
      'Help us keep the quiz system free and constantly improving. Your support enables us to add more questions, features, and maintain the platform.',
    SUPPORT_REASONS: {
      REASON1: 'Help us create more high-quality quiz questions across all categories',
      REASON2: 'Support ongoing platform maintenance and new feature development',
      REASON3: 'Enable us to keep the quiz system completely free for all developers'
    },
