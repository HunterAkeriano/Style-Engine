export default {
  ...
  FORUM: {
    TAG: 'Community forum',
    TITLE: 'Forum',
    SUBTITLE: 'Ask questions, share ideas, and get help from the Style Engine community and team.',
    ...
    PINNED_SUBTITLE: 'Highlighted by moderators so important threads stay visible.',
    ...
    MUTED_BADGE: 'Muted',
    CONFIRM_DELETE_MESSAGES: 'Are you sure you want to delete all messages from {name}?',
    ...
    CREATE: {
      ...
      SUBTITLE: 'Describe your question or idea, add details, and attach screenshots or a YouTube link.',
      TOPIC_LABEL: 'Topic title',
      TOPIC_PLACEHOLDER: 'Short, clear summary of your question',
      DESCRIPTION_LABEL: 'Description',
      DESCRIPTION_PLACEHOLDER: 'Explain the issue, steps you tried, and what you expect',
      ATTACH_TITLE: 'Attachments',
      ATTACH_HINT: 'Add up to 10 images or a YouTube link to illustrate the problem.',
      UPLOADING: 'Uploading...',
    ...
    TOPIC: {
      ...
      REPLY_HINT: 'Stay on topic and include details that help resolve the issue.',
  ...
  META_DESCRIPTION: {
    ...
    FORUM: 'Ask questions, share ideas, and discuss features in the Style Engine community forum.',
    FORUM_CREATE: 'Open a new forum topic to describe your case, attach screenshots, or link a YouTube video.',
    FORUM_TOPIC: 'Read the full conversation, status, and replies for this Style Engine forum topic.',
  ...
  ABOUT: {
    ...
    PLANS_SUBTITLE: 'Start free with all generators and forum replies. Upgrade only when you need more saves, exports, and support.',
  ...
  PRICING: {
    ...
    FEATURE_GENERATORS: 'All generators: gradients, shadows, animations, clip-paths, grid, favicon',
